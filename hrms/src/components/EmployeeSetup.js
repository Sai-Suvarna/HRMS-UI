...
// import { Form,message, Tabs, Divider } from 'antd';
...
const EmployeeSetup = () => {
  ...
  useEffect(() => {
    if (location.state && location.state.employee) {
      ...
      // Prefill form with `employeeData`
    }
  }, [location.state]);
  ...
  <div>
  <h2>{employeeData ? 'Edit Employee' : 'Add New Employee'}</h2>
    <Form form={form} onFinish={handleSubmit} layout="vertical">
      <Tabs activeKey={activeTabKey} onChange={handleTabChange}>
        ...
        >
            <Input
      value={employeeData.workDetails.empId || ''}
    ...
    />
        ...
        >
             <Input
      value={employeeData.workDetails.firstName || ''}
    ...
    />
        ...
        >
             <Input
      value={employeeData.workDetails.lastName || ''}
          ...
          {/* <Input /> */}
            ...
            <div className="form-col">
              <Form.Item label="Employment Status" name={['work_details', 'employmentStatus']} rules={[{ required: true, message: 'Please select employment status' }]}>
                {/* <Select> */}
                <Select
      value={employeeData.workDetails.employmentStatus || ''}
